...
function scene_sample02_register(){
    // シーンの登録
    let scene = createSceneObject("sample02");
    ...
    // キャラクタの登録
    let ballObject = createDGLObject("sample02", "ball");
